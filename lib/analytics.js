...
export const EVENTS = Object.freeze({
  ...
  // Garden Memory P1a. The closure metric: 3.6% of 9,562 plantings have ever
  // recorded an ending. `outcome` and `end_reason` are separate dimensions
  // because they are separate facts — a crop can give well AND be cleared for
  // space, which no previous vocabulary could express.
  PLANTING_ENDED:            "planting_ended",
